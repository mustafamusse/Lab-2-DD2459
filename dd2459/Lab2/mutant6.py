...
def IIIMutant6(element, array):
    sorted = insertionSort(array)
    memberinArray(element, sorted)

print(IIIMutant6(3, [1, 2, 48, 293293, 909, 3333, 32, 10, 11, 29, 89898, 3, 20]))

def main():
    print("RandomTesting: ", IIIMutant6(437, [9400, 437, 1904, 7686, 8625, 1606, 6042]))
